...
import { 
  CreditCard, DollarSign, BadgePercent, Banknote, 
  CircleDollarSign, ArrowDownUp, FileText, Loader2
} from "lucide-react";
              ...
              <Table>
                ...
                <TableBody>
                  ...
                  <TableRow>
                    ...
                    <TableCell>Sale</TableCell>
                    <TableCell className="text-right">+$12.75</TableCell>
                  </TableRow>
                  <TableRow>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-3 gap-2">
                <Button variant="outline" className="flex flex-col items-center h-20">
